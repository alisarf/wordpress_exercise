...
<head>
	...
	<!-- Theme CSS 
	<link rel="stylesheet" href="wp-content/themes/blog-site-template-master/style.css">
    -->


    <!-- Dynamically injecting CSS to prevent plugin conflict with relative paths , see functions.php-->
    <?php
    wp_head();
    ?>
...
<body>
    ...
    <header class="header text-center">	    
	    <a class="site-title pt-lg-4 mb-0" href="index.html">Frontpage-test.dev</a>
